...
----
/subsystem=datasources/jdbc-driver={driverdepname}:add(driver-name={driverdepname}, driver-module-name={driverdepgroup}, driver-datasource-class-name=org.postgresql.ng.jdbc.PGDataSource, driver-xa-datasource-class-name=org.postgresql.ng.jdbc.xa.PGXADataSource)
----
...
<driver name="{driverdepname}" module="{driverdepgroup}">
  <datasource-class>org.postgresql.ng.jdbc.PGXADataSource</datasource-class>
  <xa-datasource-class>org.postgresql.ng.jdbc.xa.PGXADataSource</xa-datasource-class>
</driver>
----
