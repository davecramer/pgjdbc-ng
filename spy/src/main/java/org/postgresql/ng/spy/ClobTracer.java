...
public class ClobTracer implements ClobListener {
  TraceOutput out;

  public ClobTracer(TraceOutput out) {
    this.out = out;
  }
  ...
  public void position(long result, Clob searchstr, long start) {
    trace(new Trace.Builder("Clob", "position")
  ...
  public void getAsciiStream(InputStream result) {
    trace(new Trace.Builder("Clob", "getAsciiStream")
        .returned(result)
        .build());
  }
  ...
  public void setString(int result, long pos, String str, int offset, int len) {
    trace(new Trace.Builder("Clob", "setString")
  ...
  public void setCharacterStream(Writer result, long pos) {
    trace(new Trace.Builder("Clob", "setCharacterStream")
        .withParameter("pos", pos)
        .returned(result)
        .build());
  }
  ...
  public void getCharacterStream(Reader result, long pos, long length) {
    trace(new Trace.Builder("Clob", "getCharacterStream")
        .withParameter("pos", pos)
  ...
  public void setAsciiStream(OutputStream result, long pos) {
    trace(new Trace.Builder("Clob", "setAsciiStream")
        .withParameter("pos", pos)
        .returned(result)
        .build());
  }
  ...
  public void length(long result) {
    trace(new Trace.Builder("Clob", "length")
        .returned(result)
        .build());
  }
  ...
  public void free() {
    trace(new Trace.Builder("Clob", "free")
        .returned()
        .build());
  }
  ...
  public void getSubString(String result, long pos, int length) {
    trace(new Trace.Builder("Clob", "getSubString")
        .withParameter("pos", pos)
        .withParameter("length", length)
        .returned(result)
        .build());
  ...
  public void truncate(long len) {
    trace(new Trace.Builder("Clob", "truncate")
        .withParameter("len", len)
        .returned()
        .build());
  }
